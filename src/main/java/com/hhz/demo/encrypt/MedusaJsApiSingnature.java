...
public class MedusaJsApiSingnature {

    public MedusaJsApiSingnature() {
    }

    public static String getJsApiSingnature(String url, String nonce, Long timeStamp, String jsTicket) throws MedusaEncryptException {
