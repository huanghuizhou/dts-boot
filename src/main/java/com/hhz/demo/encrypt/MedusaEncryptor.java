...
public class MedusaEncryptor {
    ...
    public MedusaEncryptor(String token, String encodingAesKey, String corpIdOrSuiteKey) throws MedusaEncryptException {
        if (null != encodingAesKey && encodingAesKey.length() == AES_ENCODE_KEY_LENGTH) {
            this.token = token;
            this.corpId = corpIdOrSuiteKey;
            this.aesKey = Base64.decodeBase64(encodingAesKey + "=");
        } else {
            throw new MedusaEncryptException(900004);
        }
    }
    ...
    public Map<String, String> getEncryptedMap(String plaintext, Long timeStamp, String nonce) throws MedusaEncryptException {
        if (null == plaintext) {
            throw new MedusaEncryptException(900001);
        } else if (null == timeStamp) {
            throw new MedusaEncryptException(900002);
        } else if (null == nonce) {
            throw new MedusaEncryptException(900003);
        } else {
    ...
    public String getDecryptMsg(String msgSignature, String timeStamp, String nonce, String encryptMsg) throws MedusaEncryptException {
        String signature = this.getSignature(this.token, timeStamp, nonce, encryptMsg);
        if (!signature.equals(msgSignature)) {
            throw new MedusaEncryptException(900006);
        } else {
    ...
    private String encrypt(String random, String plaintext) throws MedusaEncryptException {
        try {
            ...
            throw new MedusaEncryptException(900007);
        }
    }

    private String decrypt(String text) throws MedusaEncryptException {
        byte[] originalArr;
        byte[] networkOrder;
        try {
            Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
            ...
            throw new MedusaEncryptException(900008);
        }
        ...
        try {
            ...
            throw new MedusaEncryptException(900009);
        }

        if (!fromCorpid.equals(this.corpId)) {
            throw new MedusaEncryptException(900010);
        } else {
            return plainText;
        }
    }

    public String getSignature(String token, String timestamp, String nonce, String encrypt) throws MedusaEncryptException {
        try {
